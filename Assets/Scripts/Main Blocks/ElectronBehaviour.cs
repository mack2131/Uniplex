                ...
                case 0://направо
                    {
                            ...
                            GetComponent<LevelController>().level[(int)snikAll[i].snik.transform.position.x, (int)snikAll[i].snik.transform.position.y + 1] == -99)
                        {
                            if (GetComponent<LevelController>().level[(int)snikAll[i].snik.transform.position.x, (int)snikAll[i].snik.transform.position.y + 1] != -99)
                            {
                                ...
                                GetComponent<LevelController>().level[(int)snikAll[i].snik.transform.position.x, (int)snikAll[i].snik.transform.position.y + 1] = /*33*/11;
                            }
                            //освобождаем текущую
                                 ...
                                 GetComponent<LevelController>().level[(int)snikAll[i].snik.transform.position.x + 1, (int)snikAll[i].snik.transform.position.y] == -99)
                        {
                            ...
                            {   //говорим что в эту ячейку собираемся двигаться
                                GetComponent<LevelController>().level[(int)snikAll[i].snik.transform.position.x + 1, (int)snikAll[i].snik.transform.position.y] = /*33*/10;
                            }
                            //освобождаем текущую
                            GetComponent<LevelController>().level[(int)snikAll[i].snik.transform.position.x, (int)snikAll[i].snik.transform.position.y] = -1;
                            //задаем координату для движения
                ...
                case 1://left
                    {
                        ...
                        {
                            if (GetComponent<LevelController>().level[(int)snikAll[i].snik.transform.position.x - 1, (int)snikAll[i].snik.transform.position.y] != -99)
                                GetComponent<LevelController>().level[(int)snikAll[i].snik.transform.position.x - 1, (int)snikAll[i].snik.transform.position.y] = /*33*/11;
                            GetComponent<LevelController>().level[(int)snikAll[i].snik.transform.position.x, (int)snikAll[i].snik.transform.position.y] = -1;
                            snikAll[i].newX = (int)snikAll[i].snik.transform.position.x - 1;
    ...
    void MoveRight()
    {
        ...
        for (int i = 0; i < snikRight.Count; i++)
        {
            ...
            else//когда уже достачно близко от нужной позиции
            {
                ...
                //занимаем ячейку
                GetComponent<LevelController>().level[snikRight[i].newX, (int)snikRight[i].snik.transform.position.y] = 11;
                //добавляем в основной список
    ...
    void MoveLeft()
    {
        ...
        for (int i = 0; i < snikLeft.Count; i++)
        {
            ...
            else
            {
                ...
                //занимаем ячейку
                GetComponent<LevelController>().level[snikLeft[i].newX, (int)snikLeft[i].snik.transform.position.y] = 11;
                //добавляем в основной список
    ...
    void MoveDown()
    {
        ...
        for (int i = 0; i < snikDown.Count; i++)
        {
            ...
            else
            {
                ...
                //занимаем ячейку
                GetComponent<LevelController>().level[(int)snikDown[i].snik.transform.position.x, snikDown[i].newY] = 11;
                //добавляем в основной список
    ...
    void MoveUp()
    {
        ...
        for (int i = 0; i < snikUp.Count; i++)
        {
            ...
            else
            {
                ...
                //занимаем ячейку
                GetComponent<LevelController>().level[(int)snikUp[i].snik.transform.position.x, snikUp[i].newY] = 11;
                //добавляем в основной список
